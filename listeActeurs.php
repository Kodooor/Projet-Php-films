...
<head>
  <meta charset="utf-8" />
  <link rel="stylesheet"/>
  <title> SQLite_listeActeurs </title>
</head>
<body>
<?php
  try{
    $file_db = new PDO('sqlite:BD/listeActeurs.sqlite');
...
array(518, 413)
    ...
    $insert = "INSERT INTO Acteurs (ref_code_film, ref_code_acteur)
    ...
    foreach($acteurs_test as $c){
      $ref_code_film = $c[0];
      $ref_code_acteur = $c[1];
      $stmt->execute();
    }
    echo "Les Acteurs" . "<br>";
    $result = $file_db->query('SELECT * FROM Acteurs;');
