...
<head>
  <meta charset="utf-8" />
  <link rel="stylesheet"/>
  <title> SQLite_listeClassification </title>
</head>
<body>
<?php
  try{
    $file_db = new PDO('sqlite:../BD/listeClassification.sqlite');
    $file_db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
    $file_db->exec("CREATE TABLE IF NOT EXISTS Classification(
      ref_code_film INTEGER,
      ref_code_genre INTEGER
    )"
  );

    // $lines = file('classification.txt');
    // foreach ($lines as $lineContent)
    // {
    // 	echo "array" . $lineContent . "<br>";
    // }
    $classification_test = array(
      array(43, 4),
array(43, 14),
array(68, 10),
array(68, 6),
...
array(568, 8)
    ...
    echo "Les Classification" . "<br>";
    $result = $file_db->query('SELECT * FROM Classification;');
